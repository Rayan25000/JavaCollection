    ...
    public void rencontrer(Animal animal, Savane savane){
        if(animal instanceof Lion){
            if(!this.sexe.equals(animal.sexe)) {
                ...
                if(rand == 1 ){
                    listAnimal.add(new Lion(concat, "male"));
                    System.out.println("Nouveau Lion male");
                } else if(rand == 2){
                    listAnimal.add(new Lion(concat, "femelle"));
                    System.out.println("Nouveau Lion femelle");
                }
            } else {
                //il manque la possibilité d'effacer les lions mort de la liste (nécessite un index dans Lion)
